...
<img src={useBaseUrl('/img/rating/examples/styling-hover.gif')} alt="Hovering a rating with a slow transition and a distinct green hover colour" width="260" />
...
<img src={useBaseUrl('/img/rating/examples/styling-gallery.png')} alt="A gallery of ratings styled with different sizes, gaps, colours, and empty-layer filters" width="520" />
