...
<img src={useBaseUrl('/img/rating/examples/interactive-half.gif')} alt="Hovering and clicking a half-star rating" width="240" />
...
<img src={useBaseUrl('/img/rating/examples/interactive-keyboard.gif')} alt="Selecting a rating with the arrow keys, then clearing with Backspace" width="240" />
...
preview, focus, group blur, fills, and steps — in ~900 B. See the [API reference](/rating/api).
