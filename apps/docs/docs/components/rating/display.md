...
| Code                                            | Result                                                                                                  |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| `<Rating value={4.3} />`                        | <img src={useBaseUrl('/img/rating/examples/continuous.png')} alt="4.3 stars, continuous" width="200" /> |
| `<Rating value={4.3} precision={1} />`          | <img src={useBaseUrl('/img/rating/examples/whole.png')} alt="4 whole stars" width="200" />              |
| `<Rating value={4.3} precision={0.5} />`        | <img src={useBaseUrl('/img/rating/examples/half.png')} alt="4.5 stars" width="200" />                   |
| `<Rating value={4.3} icon="⭐" />`              | <img src={useBaseUrl('/img/rating/examples/emoji.png')} alt="emoji rating" width="200" />               |
| `<Rating value={3} max={5} icon={<Heart />} />` | <img src={useBaseUrl('/img/rating/examples/hearts.png')} alt="3 of 5 hearts" width="200" />             |
...
<img src={useBaseUrl('/img/rating/examples/max10.png')} alt="7.5 out of 10 stars" width="320" />
...
[Custom icons](/components/rating/custom-icons) for the full pattern and the emoji color-font caveat.
...
More visual knobs — colors, gap, the empty-layer filter — are in [Styling](/guides/styling).
