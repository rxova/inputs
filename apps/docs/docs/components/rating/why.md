...
Rounding is a separate, explicit decision (see [Displaying a score](/components/rating/display)): two
...
to reimplement them (imperfectly). Details in [Accessibility](/guides/accessibility).
