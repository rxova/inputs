...
- **WebOTP** — programmatic SMS retrieval ([`useWebOTP`](/components/otp/webotp)) that no other OTP
  library ships.
...
More on the architecture and its one honest tradeoff in [Why this exists](/components/otp/why).
...
- [Spatial slots](/components/otp/spatial-slots) — tap-to-edit and the iOS tradeoff
- [Codes & autofill](/components/otp/codes-and-autofill) — paste, SMS, and WebOTP
- [Accessibility](/guides/accessibility) · [Styling](/guides/styling) · [Forms](/components/otp/forms)
- [Migrating](/migrating/from-input-otp) from another OTP library
