...
| `handle*`           | `InputChange`, `DragOver`, `DragLeave`, `Drop`, `Focus`, `Blur`   |

## Styling

No stylesheet ships. Structure only, with `data-*` hooks covered by semver:

`data-rfi-root`, `data-rfi-input`, `data-rfi-zone`, `data-rfi-list`, `data-rfi-file`,
`data-rfi-name`, `data-rfi-size`, `data-rfi-preview`, `data-rfi-remove`, `data-rfi-announcement`,
...
[data-rfi-root][data-dragging] [data-rfi-zone] {
